...
#+BEGIN_SRC shell :tangle scripts/install :mkdirp yes :shebang #!/bin/sh
  ...
  apt-get install -y zsh apt-utils locales automake htop curl wget git silversearcher-ag neovim docker.io tmux emacs-nox tree > /dev/null
#+END_SRC
