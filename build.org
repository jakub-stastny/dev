...
#+begin_src clojure
  ...
  (defn- format-duration-wrapper
    ([duration]
     (if-let [formatted-duration (format-duration duration)] (str "took " (format-duration duration) ".") ""))

    ([duration lambda]
     (if-let [formatted-duration (format-duration duration)] (lambda (format-duration-wrapper duration)) "")))
