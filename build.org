...
#+begin_src clojure :tangle scripts/add-node-sources
  ...
  (block "Download ET"
    (run "mkdir -p $HOME/.local/share/et")
    (run " wget --quiet https://github.com/jakub-stastny/et/raw/doc/doc/downloads/et.jar -P $HOME/.local/share/et"))
#+end_src
