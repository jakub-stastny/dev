...
#+begin_src clojure
  ...
  ;;    (format-duration-unless-instant duration #(lambda (format-duration-wrapper %)))))
  (defn- format-duration-wrapper
    ([duration]
     (format-duration-unless-instant duration #(str "took " % ".")))
    ([duration lambda]
     (format-duration-unless-instant duration (lambda (format-duration-wrapper duration)))))

  (comment
    (format-duration-wrapper 1)
    (format-duration-wrapper 37)
    (format-duration-wrapper 92)
    (format-duration-wrapper 1 #(str "~ " %))
    (format-duration-wrapper 37 #(str "~ " %))
    (format-duration-wrapper 92 #(str "~ " %)))
