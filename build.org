...
My development environment with my favourite tools and dotfiles. For usage, please check out the [[../][README]]. This is the developer documentation, describing the implementation and reasoning if aplicable.
